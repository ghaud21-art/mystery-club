...
// ── 샘플 데이터 ───────────────────────────────────
const INIT_MB = [
  {id:1,name:"김민준",av:"🕵️",role:"admin",style:"분석형",style2:"논리형",pw:"1111",friends:[2,3]},
  {id:2,name:"이서연",av:"🌸",role:"member",style:"감성형",style2:"연기형",pw:"2222",friends:[1,4]},
  {id:3,name:"박도현",av:"🎭",role:"member",style:"연기형",style2:"직관형",pw:"3333",friends:[1,5]},
  {id:4,name:"최지아",av:"⚡",role:"member",style:"직관형",style2:"분석형",pw:"4444",friends:[2,5]},
  {id:5,name:"정우진",av:"📐",role:"member",style:"논리형",style2:"감성형",pw:"5555",friends:[3,4]},
];

const INIT_GR=[
  {id:1,name:"홍대 추리단",owner:1,members:[1,2,3,4],desc:"홍대 중심 모임"},
  {id:2,name:"강남 탐정들",owner:4,members:[4,5,2],desc:"강남권 활동"},
];

const SCENS=[
  {id:1,title:"검은 저택의 비밀",theme:"공포",pl:"4-6",time:180,diff:4,rating:4.5,ok:true,tags:["밀실","유령"],
   characters:[
     {id:1,name:"레이놀즈 탐정",hint:"사건 조사를 위해 파견된 노련한 탐정",roleType:"탐정"},
     {id:2,name:"블랙우드 백작",hint:"저택의 주인. 뭔가를 숨기고 있다",roleType:"범인"},
     {id:3,name:"에밀리 가정교사",hint:"아이들을 가르치는 신비로운 여인",roleType:"조연"},
     {id:4,name:"찰스 집사",hint:"20년 경력의 충직한 집사",roleType:"조연"},
     {id:5,name:"로즈 백작부인",hint:"백작의 아내. 공포에 떨고 있다",roleType:"피해자"},
   ]},
  {id:2,title:"베네치아의 독",theme:"로맨스",pl:"3-5",time:150,diff:3,rating:4.2,ok:true,tags:["독살"],
   characters:[
     {id:1,name:"마르코 총독",hint:"베네치아를 통치하는 권력자",roleType:"피해자"},
     {id:2,name:"루치아 백작부인",hint:"아름답고 야심찬 귀족 여인",roleType:"범인"},
     {id:3,name:"조반니 의사",hint:"총독의 주치의. 독에 대해 잘 안다",roleType:"조연"},
     {id:4,name:"피에로 가면 상인",hint:"카니발 가면을 파는 수상한 인물",roleType:"조연"},
   ]},
  {id:3,title:"마지막 만찬",theme:"고전",pl:"6-8",time:200,diff:5,rating:4.8,ok:true,tags:["만찬","귀족"],
   characters:[
     {id:1,name:"헨리 경",hint:"만찬을 주최한 노귀족",roleType:"피해자"},
     {id:2,name:"빅토리아 부인",hint:"상속을 노리는 조카딸",roleType:"범인"},
     {id:3,name:"알프레드 변호사",hint:"유언장을 관리하는 변호사",roleType:"조연"},
     {id:4,name:"셜록 탐정관",hint:"만찬 중 우연히 방문한 탐정",roleType:"탐정"},
     {id:5,name:"도로시 가정부",hint:"30년을 섬긴 충직한 하녀",roleType:"조연"},
     {id:6,name:"에드워드 아들",hint:"방탕한 생활로 빚이 많다",roleType:"조연"},
   ]},
  {id:4,title:"달빛 아래 살인",theme:"미스터리",pl:"4-6",time:160,diff:3,rating:4.0,ok:true,tags:["달밤"],
   characters:[
     {id:1,name:"문 형사",hint:"야간 순찰 중 사건을 발견했다",roleType:"탐정"},
     {id:2,name:"달빛 카페 주인",hint:"현장 근처 카페를 운영한다",roleType:"범인"},
     {id:3,name:"야간 경비원",hint:"그날 밤 뭔가를 봤다고 한다",roleType:"목격자"},
     {id:4,name:"연인 A",hint:"피해자의 전 연인",roleType:"조연"},
     {id:5,name:"연인 B",hint:"피해자의 현 연인",roleType:"조연"},
   ]},
  {id:5,title:"폐열차의 미스터리",theme:"스릴러",pl:"5-7",time:190,diff:4,rating:4.6,ok:true,tags:["기차"],
   characters:[
     {id:1,name:"카터 형사",hint:"실종 사건을 추적하던 형사",roleType:"탐정"},
     {id:2,name:"레나 백작부인",hint:"열차에 탄 신비로운 귀족",roleType:"범인"},
     {id:3,name:"맥스 기관사",hint:"수십 년 경력의 베테랑 기관사",roleType:"조연"},
     {id:4,name:"조세핀 간호사",hint:"병원에서 도망쳐 온 수상한 인물",roleType:"조연"},
     {id:5,name:"월터 상인",hint:"고가의 화물을 운반 중이다",roleType:"조연"},
     {id:6,name:"소피아 소녀",hint:"혼자 탑승한 어린 소녀. 비밀이 있다",roleType:"목격자"},
   ]},
  {id:6,title:"탐정 사무소 사건",theme:"코미디",pl:"3-5",time:120,diff:2,rating:3.9,ok:true,tags:["코미디"],
   characters:[
     {id:1,name:"왓슨 탐정",hint:"의외로 엉뚱한 추리를 하는 탐정",roleType:"탐정"},
     {id:2,name:"미미 비서",hint:"탐정보다 더 유능한 비서",roleType:"조연"},
     {id:3,name:"도넛 경위",hint:"항상 도넛을 먹고 있는 경찰",roleType:"조연"},
     {id:4,name:"블라블라 의뢰인",hint:"사건을 의뢰했지만 뭔가 수상하다",roleType:"범인"},
   ]},
  {id:7,title:"심해의 비명",theme:"공포",pl:"4-6",time:170,diff:4,rating:null,ok:false,sub:2,tags:["바다"],note:"직접 개발!",st:"pending",subAt:"2025-04-10",
   characters:[]},
];

const INIT_RC=[
  {id:1,scId:1,date:"2025-03-01",mbs:[1,2,3,4],res:"성공",mvp:2,
   charNames:{1:"레이놀즈 탐정",2:"블랙우드 백작",3:"에밀리 가정교사",4:"찰스 집사"},
   roleTypes:{1:"탐정",2:"범인",3:"조연",4:"조연"},
   rats:{1:5,2:4,3:5,4:4},rev:"밀실 트릭 독창적!",sp:true},
  {id:2,scId:2,date:"2025-03-15",mbs:[1,2,4,5],res:"실패",mvp:4,
   charNames:{1:"마르코 총독",2:"루치아 백작부인",4:"조반니 의사",5:"피에로 가면 상인"},
   roleTypes:{1:"피해자",2:"범인",4:"조연",5:"조연"},
   rats:{1:4,2:5,4:4,5:3},rev:"범인 연기 완벽",sp:false},
  {id:3,scId:3,date:"2025-04-02",mbs:[1,3,5],res:"성공",mvp:1,
   charNames:{1:"셜록 탐정관",3:"빅토리아 부인",5:"알프레드 변호사"},
   roleTypes:{1:"탐정",3:"범인",5:"조연"},
   rats:{1:5,3:4,5:5},rev:"스케일 최고",sp:false},
];

const INIT_SC=[
  {id:1,scId:5,title:"폐열차의 미스터리",date:"2025-04-28",time:"19:00",host:1,max:6,att:[1,2,3],loc:"홍대 미스터리룸",gId:1},
  {id:2,scId:4,title:"달빛 아래 살인",date:"2025-05-10",time:"18:00",host:4,max:5,att:[4,5],loc:"강남 이스케이프",gId:null},
];
...
const inp={width:"100%",padding:"10px 14px",background:"#FFFDF9",border:"1.5px solid #E5D9C8",borderRadius:8,color:"#1C1612",fontSize:13,fontFamily:"inherit"};
const CSS=`
...
const Hdr=({title,sub,action})=>(
  <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-end",marginBottom:24}}>
    <div>
      <h1 style={{fontFamily:"'Playfair Display',serif",fontSize:24,fontWeight:700,color:T.text}}>{title}</h1>
...
const Modal=({title,onClose,children})=>(
  <div style={{position:"fixed",inset:0,background:"rgba(28,22,18,.5)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:200,padding:20}} onClick={onClose}>
    <div style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:16,width:"100%",maxWidth:520,maxHeight:"90vh",overflowY:"auto",boxShadow:"0 8px 40px rgba(92,60,24,.18)"}} onClick={e=>e.stopPropagation()}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"18px 22px",borderBottom:`1px solid ${T.border}`}}>
        <span style={{fontFamily:"'Playfair Display',serif",fontSize:17,fontWeight:700,color:T.gold}}>{title}</span>
...
export default function App(){
  ...
  const addFri=fid=>{
    setMbs(p=>p.map(m=>{
      if(m.id===me.id)return{...m,friends:[...new Set([...m.friends,fid])]};
      if(m.id===fid)return{...m,friends:[...new Set([...m.friends,me.id])]};
      return m;
    }));
...
function Login({mbs,onLogin,onSignup}){
  ...
  const go=()=>{if(!sel)return;if(pw===sel.pw)onLogin(sel);else{setErr(true);setTimeout(()=>setErr(false),1400);}};
  return (
    <div style={{minHeight:"100vh",background:T.bg,display:"flex",alignItems:"center",justifyContent:"center"}}>
      <div style={{width:420,background:T.card,borderRadius:20,padding:"42px 38px",border:`1px solid ${T.border}`,boxShadow:"0 8px 40px rgba(92,60,24,.14)"}}>
        <div style={{textAlign:"center",marginBottom:28}}>
          <div style={{fontFamily:"'Playfair Display',serif",fontSize:26,fontWeight:700,color:T.gold}}>🕯 Mystery Club</div>
          <div style={{fontSize:11,color:T.muted,marginTop:3,letterSpacing:2}}>DETECTIVE SOCIETY</div>
        </div>
        <div style={{fontSize:12,fontWeight:700,color:T.sub,marginBottom:9}}>탐정을 선택하세요</div>
        <div style={{display:"flex",flexDirection:"column",gap:6,marginBottom:16}}>
          {mbs.map(m=>{
            const s=SM[m.style]||{};const s2=m.style2?SM[m.style2]:null;
            return (
              <div key={m.id} className="hov" onClick={()=>{setSel(m);setPw("");setErr(false);}}
                style={{display:"flex",alignItems:"center",gap:11,padding:"10px 13px",borderRadius:10,
                  border:`1.5px solid ${sel?.id===m.id?T.gold:T.border}`,
                  background:sel?.id===m.id?T.goldL:T.paper,cursor:"pointer"}}>
                <span style={{fontSize:21}}>{m.av}</span>
                <div style={{flex:1}}>
                  <div style={{fontSize:13,fontWeight:600,color:T.text}}>{m.name}</div>
                  <div style={{fontSize:11,color:s.color||T.muted}}>{s.icon} {m.style}{s2?<span style={{color:T.muted}}> + {s2.icon} {m.style2}</span>:""}</div>
                </div>
                {sel?.id===m.id&&<span style={{color:T.gold}}>✓</span>}
              </div>
            );
          })}
        </div>
        {sel&&(
          <div style={{marginBottom:14}}>
            <label style={{fontSize:11,fontWeight:700,color:T.sub,display:"block",marginBottom:5}}>비밀번호 <span style={{color:T.muted,fontWeight:400}}>(데모: {sel.pw})</span></label>
            <input type="password" value={pw} onChange={e=>setPw(e.target.value)} onKeyDown={e=>e.key==="Enter"&&go()} style={{...inp,borderColor:err?"#B91C1C":T.border}} placeholder="비밀번호 입력" />
            {err&&<div style={{fontSize:11,color:T.red,marginTop:4}}>비밀번호가 틀렸습니다.</div>}
          </div>
        )}
        <GBtn full onClick={go} disabled={!sel}>입장하기</GBtn>
        <button className="btn" onClick={onSignup} style={{width:"100%",padding:9,background:"transparent",color:T.gold,borderRadius:10,fontSize:13,border:`1.5px solid ${T.gold}`,marginTop:8}}>+ 새 계정 만들기</button>
      </div>
    </div>
  );
}
...
function Signup({onDone,onBack,ids}){
  ...
  const finish=()=>{
    ...
    onDone({id,name:form.name,av:form.av,role:"member",style:result.style,style2:result.style2,pw:form.pw,friends:[]});
  };
    ...
    <div style={{minHeight:"100vh",background:T.bg,display:"flex",alignItems:"center",justifyContent:"center"}}>
      <div style={{width:500,background:T.card,borderRadius:20,padding:38,border:`1px solid ${T.border}`,boxShadow:"0 8px 40px rgba(92,60,24,.14)"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:18}}>
          <div style={{fontFamily:"'Playfair Display',serif",fontSize:19,fontWeight:700,color:T.gold}}>🕯 탐정 등록</div>
        ...
        {step===SURVEY.length+2&&(
          <div className="fade">
            ...
            <div style={{background:T.goldL,borderRadius:9,padding:"11px 14px",marginBottom:13}}>
              ...
              <div style={{fontSize:11,color:"#92400E",fontFamily:"monospace",lineHeight:1.8}}>날짜, 결과, 캐릭터명, 평점, 후기<br/>2025-03-01, 성공, 레이놀즈 탐정, 5, 재밌었음</div>
            </div>
  ...
  return (
    <div style={{width:214,background:T.card,borderRight:`1px solid ${T.border}`,display:"flex",flexDirection:"column",position:"sticky",top:0,height:"100vh"}}>
      <div style={{padding:"20px 18px 14px",borderBottom:`1px solid ${T.border}`}}>
        <div style={{fontFamily:"'Playfair Display',serif",fontSize:16,fontWeight:700,color:T.gold}}>🕯 Mystery Club</div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:12,marginBottom:20}}>
        {[
          ...
          <div key={x.l} className="hov" style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:11,padding:"16px 18px",boxShadow:T.sh}}>
            ...
            <div style={{fontSize:21,fontWeight:700,color:x.c,fontFamily:"'Playfair Display',serif"}}>{x.v}</div>
    ...
    <div className="fade">
      <div style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:15,padding:"20px 24px",marginBottom:18,boxShadow:T.sh}}>
        <div style={{display:"flex",gap:16,alignItems:"center",flexWrap:"wrap"}}>
          ...
          <div style={{flex:1}}>
            <div style={{fontFamily:"'Playfair Display',serif",fontSize:20,fontWeight:700,color:T.text}}>{me.name}</div>
            ...
            <div style={{display:"flex",gap:16,marginTop:11}}>
              {[["총 플레이",`${myR.length}회`],["성공",`${wins}회`],["실패",`${myR.length-wins}회`],["MVP",`${myR.filter(r=>r.mvp===me.id).length}회`]].map(([l,v])=>(
                <div key={l}><div style={{fontSize:17,fontWeight:700,color:T.gold,fontFamily:"'Playfair Display',serif"}}>{v}</div><div style={{fontSize:10,color:T.muted}}>{l}</div></div>
              ))}
            </div>
          </div>
          ...
          {sf&&ci&&(
            <div className="fade">
              <div style={{background:T.card,border:`2px solid ${ci.c}20`,borderRadius:15,padding:"24px 28px",marginBottom:16,boxShadow:T.sh,textAlign:"center"}}>
                ...
                <div style={{fontFamily:"'Playfair Display',serif",fontSize:48,fontWeight:700,color:ci.c,lineHeight:1}}>{cs}</div>
          ...
          return(
            <div className="fade">
              <div style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:13,padding:"18px 22px",marginBottom:13,boxShadow:T.sh}}>
                <div style={{fontFamily:"'Playfair Display',serif",fontSize:17,fontWeight:700,color:T.text,marginBottom:3}}>{sg.name}</div>
                ...
                <Sec title={`💑 궁합 랭킹 (평균 ${avg}점)`}>
                  {pairs.map((p,i)=>{const info=cLabel(p.sc);return(
                    <div key={i} style={{display:"flex",alignItems:"center",gap:7,padding:"8px 0",borderBottom:`1px solid ${T.border}`}}>
                      ...
                      <div style={{fontFamily:"'Playfair Display',serif",fontSize:17,fontWeight:700,color:info.c}}>{p.sc}</div>
                    </div>
                  );})}
                </Sec>
              </div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:13}}>
        {recs.map(r=>{const sc=scens.find(s=>s.id===r.scId);const mvpM=mbs.find(m=>m.id===r.mvp);return(
          <div key={r.id} className="hov" style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:11,padding:16,boxShadow:T.sh}}>
            <div style={{display:"flex",justifyContent:"space-between",marginBottom:6}}><div style={{fontSize:14,fontWeight:700,fontFamily:"'Playfair Display',serif",color:T.text}}>{sc?.title}</div><Pill ok={r.res==="성공"}>{r.res}</Pill></div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:13}}>
        {official.map(s=>(
          <div key={s.id} className="hov" style={{background:T.card,border:`1px solid ${expanded===s.id?T.gold:T.border}`,borderRadius:11,padding:16,boxShadow:T.sh}} onClick={()=>setExpanded(expanded===s.id?null:s.id)}>
            ...
            <div style={{fontSize:14,fontWeight:700,fontFamily:"'Playfair Display',serif",color:T.text,marginBottom:6}}>{s.title}</div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:15}}>
        {schs.map(s=>{const host=mbs.find(m=>m.id===s.host);const att=s.att.includes(me.id);const grp=grps.find(g=>g.id===s.gId);const pct=Math.round(s.att.length/s.max*100);return(
          <div key={s.id} className="hov" style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:13,padding:20,boxShadow:T.sh}}>
            ...
            <div style={{fontSize:17,fontWeight:700,fontFamily:"'Playfair Display',serif",color:T.text,marginBottom:4}}>{s.title}</div>
